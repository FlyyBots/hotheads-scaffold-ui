...
contract SHARE is ERC20Permit, Ownable {
    using SafeMath for uint256;
    using SafeERC20 for IERC20;

    constructor() ERC20("SHARE", "SHARE") ERC20Permit("SHARE")
    {
    }

    uint256 constant public _maxTotalSupply = 55000e18;
    ...
    function set_vest(address[] memory _vested_addresses, uint256[] memory _alloc_emission, address _farm) public onlyOwner {
